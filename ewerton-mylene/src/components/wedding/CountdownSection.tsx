...
const CountdownSection = () => {
  ...
  return (
    <section className="py-20 md:py-28 bg-[#CACDB6] text-primary-foreground">
          ...
          {timeBlocks.map((block, index) => (
            <div key={block.label} className="flex items-center gap-4 md:gap-8">
              <Reveal variant="zoom-in" delay={index * 0.1} className="flex flex-col items-center">
                <div className="countdown-digit bg-[#3A4A40] w-16 h-16 md:w-24 md:h-24 flex items-center justify-center text-2xl md:text-4xl font-display mb-2">
